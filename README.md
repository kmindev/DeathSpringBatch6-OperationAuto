...
| ex7 | JobParametersValidator 예제 (시스템 파괴 Job, destructionPower는 9 이하만 허용) | `./gradlew bootRun --args='--spring.batch.job.name=systemDestructionJob destructionPower=9,java.lang.Long'` |
